...
export class AppComponent implements OnInit, OnDestroy {
  ...
  /**
   * Sync current user từ backend
   * Dùng khi OAuth2 redirect về với JWT trong cookie
   * Kiểm tra xem localStorage có currentUser không, nếu không thì gọi /auth/me
   */
  ...
  async ngOnInit(): Promise<void> {
    ...
    // Sync user info từ backend (quan trọng cho OAuth2 redirect)
