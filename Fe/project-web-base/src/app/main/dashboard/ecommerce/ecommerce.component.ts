...
import { locale as vietnamese } from 'app/main/dashboard/i18n/vn';
...
export class EcommerceComponent implements OnInit {
  ...
  constructor(
    ...
    this._coreTranslationService.translate(english, french, german, portuguese, vietnamese);
  ...
  ngOnInit(): void {
    ...
    this.data = this._dashboardService.apiData;
  }
  ...
  ngAfterViewInit() {
    ...
    this._coreConfigService.getConfig().subscribe(config => {
      ...
      if(config.app) {
        this._translate.currentLang = config.app.appLanguage
      }
      if (
