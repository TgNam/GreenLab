...
import { DiscountTypesListComponent } from './discount-types-list/discount-types-list.component';
import { DiscountTypeService } from '../../services/lab-tests/discount-type.service';

const routes: Routes = [
  { path: '', component: DiscountTypesListComponent }
];

@NgModule({
  declarations: [DiscountTypesListComponent],
  imports: [
