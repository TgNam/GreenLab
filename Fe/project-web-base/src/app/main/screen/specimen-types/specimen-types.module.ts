...
import { SpecimenTypesListComponent } from './specimen-types-list/specimen-types-list.component';
import { SpecimenTypeService } from '../../services/lab-tests/specimen-type.service';

const routes: Routes = [
  { path: '', component: SpecimenTypesListComponent }
];

@NgModule({
  declarations: [SpecimenTypesListComponent],
  imports: [
