...
import vn.greenlab.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
import vn.greenlab.security.oauth2.OAuth2AuthenticationFailureHandler;
import vn.greenlab.security.oauth2.OAuth2AuthenticationSuccessHandler;
import vn.greenlab.service.AdministratorService;
import vn.greenlab.security.oauth2.CustomOAuth2UserService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,ClientRegistrationRepository clientRegistrationRepository) throws Exception {
        // 1. Khởi tạo Resolver và ép bật PKCE cho tất cả các Request OAuth2
        ...
        http
                ...
                .oauth2Login(oauth2 -> oauth2
                                .authorizationEndpoint(authEndpoint -> authEndpoint
                                        // Endpoint FE sẽ gọi (mặc định của Spring là /oauth2/authorization)
                                        .baseUri("/oauth2/authorization")
                                        // Repository giữ redirect_uri của từng FE
                                        .authorizationRequestRepository(httpCookieOAuth2AuthorizationRequestRepository)
                                        // 2. Thêm resolver có chứa PKCE vào đây
                                        .authorizationRequestResolver(resolver)
                                )
                                .redirectionEndpoint(redirectionEndpoint -> redirectionEndpoint
                                        // Phải khớp với Authorized redirect URIs bạn cung cấp: /api-admin/oauth2/code/*
                                        .baseUri("/oauth2/code/*")
                                )
                                .userInfoEndpoint(userInfoEndpoint -> userInfoEndpoint
                                        // Xử lý logic check User tồn tại
