package vn.greenlab.model.input.sms_template;
...
@AllArgsConstructor
@Builder
@Schema(description = "Model tìm kiếm biểu mẫu SMS")
public class SmsTemplateSearch {
    ...
    @Schema(description = "ID biểu mẫu SMS")
    private Long id;
    ...
    @Schema(description = "Tên biểu mẫu")
    private String name;

    @Schema(description = "Loại biểu mẫu SMS")
    private SmsOutboxType type;

    @Schema(description = "Loại người nhận")
